...
implements Util {
    ...
    public static void boxESP(BlockPos blockPos, Color color, float f, boolean bl, boolean bl2, int n, boolean bl3) {
        ...
        if (camera.func_78546_a(new AxisAlignedBB(axisAlignedBB.field_72340_a + RenderUtil.mc.func_175598_ae().field_78730_l, axisAlignedBB.field_72338_b + RenderUtil.mc.func_175598_ae().field_78731_m, axisAlignedBB.field_72339_c + RenderUtil.mc.func_175598_ae().field_78728_n, axisAlignedBB.field_72336_d + RenderUtil.mc.func_175598_ae().field_78730_l, axisAlignedBB.field_72337_e + RenderUtil.mc.func_175598_ae().field_78731_m, axisAlignedBB.field_72334_f + RenderUtil.mc.func_175598_ae().field_78728_n))) {
            ...
            f2 = Math.min(f2, 1.0f);
            if (bl3) {
                d6 = axisAlignedBB.field_72340_a + 0.5 - (double)(f2 / 2.0f);
                d5 = axisAlignedBB.field_72338_b + 0.5 - (double)(f2 / 2.0f);
                d4 = axisAlignedBB.field_72339_c + 0.5 - (double)(f2 / 2.0f);
                d3 = axisAlignedBB.field_72336_d - 0.5 + (double)(f2 / 2.0f);
                d2 = axisAlignedBB.field_72337_e - 0.5 + (double)(f2 / 2.0f);
                d = axisAlignedBB.field_72334_f - 0.5 + (double)(f2 / 2.0f);
            } else {
                d6 = axisAlignedBB.field_72340_a + 0.5 - d8 / 2.0;
                d5 = axisAlignedBB.field_72338_b + 0.5 - d8 / 2.0;
                d4 = axisAlignedBB.field_72339_c + 0.5 - d8 / 2.0;
                d3 = axisAlignedBB.field_72336_d - 0.5 + d8 / 2.0;
                d2 = axisAlignedBB.field_72337_e - 0.5 + d8 / 2.0;
                d = axisAlignedBB.field_72334_f - 0.5 + d8 / 2.0;
            }
    ...
    public static void drawGuiGradientRect(float x, float y, float w, float h, int color) {
        ...
        BufferBuilder vertexbuffer = tessellator.func_178180_c();
        vertexbuffer.func_181668_a(7, DefaultVertexFormats.field_181706_f);
        vertexbuffer.func_181662_b((double)x, (double)h, 0.0).func_181666_a(red, green, blue, alpha).func_181675_d();
        vertexbuffer.func_181662_b((double)w, (double)h, 0.0).func_181666_a(red, green, blue, alpha).func_181675_d();
        vertexbuffer.func_181662_b((double)w, (double)y, 0.0).func_181666_a(red, green, blue, alpha).func_181675_d();
        vertexbuffer.func_181662_b((double)x, (double)y, 0.0).func_181666_a(red, green, blue, alpha).func_181675_d();
        tessellator.func_78381_a();
        GlStateManager.func_179103_j((int)7424);
        GlStateManager.func_179084_k();
        GlStateManager.func_179141_d();
