...
public class IAS {
    ...
    public void preInit(FMLPreInitializationEvent event) {
        ...
        config.load();
        CASESENSITIVE_PROPERTY = config.get("general", "ias.cfg.casesensitive", false, I18n.func_135052_a((String)"ias.cfg.casesensitive.tooltip", (Object[])new Object[0]));
        ENABLERELOG_PROPERTY = config.get("general", "ias.cfg.enablerelog", false, I18n.func_135052_a((String)"ias.cfg.enablerelog.tooltip", (Object[])new Object[0]));
        IAS.syncConfig();
