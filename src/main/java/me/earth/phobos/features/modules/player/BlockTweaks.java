...
public class BlockTweaks extends Module
{
    ...
    public void onPacketSend(final PacketEvent.Send event) {
        ...
        final Entity entity;
        if (this.noFriendAttack.getValue() && event.getPacket() instanceof CPacketUseEntity && (entity = ((CPacketUseEntity)event.getPacket()).getEntityFromWorld((World)BlockTweaks.mc.world)) != null && Phobos.friendManager.isFriend(entity.getName())) {
