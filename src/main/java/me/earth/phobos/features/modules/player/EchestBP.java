...
extends Module {
    ...
    public void onUpdate() {
        Container container;
        if (EchestBP.mc.field_71462_r instanceof GuiContainer && (container = ((GuiContainer)EchestBP.mc.field_71462_r).field_147002_h) instanceof ContainerChest && ((ContainerChest)container).func_85151_d() instanceof InventoryBasic && ((ContainerChest)container).func_85151_d().func_70005_c_().equalsIgnoreCase("Ender Chest")) {
