...
public class AutoBuilder extends Module
{
    ...
    public AutoBuilder() {
        ...
        this.settings = (Setting<Settings>)this.register(new Setting("Settings", Settings.PATTERN));
        this.mode = (Setting<Mode>)this.register(new Setting("Mode", Mode.STAIRS,  v -> this.settings.getValue() == Settings.PATTERN));
        this.stairDirection = (Setting<Direction>)this.register(new Setting("Direction", Direction.NORTH,  v -> this.mode.getValue() == Mode.STAIRS && this.settings.getValue() == Settings.PATTERN));
        this.width = (Setting<Integer>)this.register(new Setting("StairWidth", 40, 1, 100,  v -> this.mode.getValue() == Mode.STAIRS && this.settings.getValue() == Settings.PATTERN));
        this.dynamic = (Setting<Boolean>)this.register(new Setting("Dynamic", true,  v -> this.mode.getValue() == Mode.FLAT && this.settings.getValue() == Settings.PATTERN));
        this.setPos = (Setting<Boolean>)this.register(new Setting("ResetPos", false,  v -> this.settings.getValue() == Settings.PATTERN && (this.mode.getValue() == Mode.STAIRS || (this.mode.getValue() == Mode.FLAT && !this.dynamic.getValue()))));
        this.range = (Setting<Float>)this.register(new Setting("Range", 4.0f, 1.0f, 6.0f,  v -> this.settings.getValue() == Settings.PLACE));
        this.blocksPerTick = (Setting<Integer>)this.register(new Setting("Blocks/Tick", 3, 1, 8,  v -> this.settings.getValue() == Settings.PLACE));
        this.placeDelay = (Setting<Integer>)this.register(new Setting("PlaceDelay", 150, 0, 500,  v -> this.settings.getValue() == Settings.PLACE));
        this.rotate = (Setting<Boolean>)this.register(new Setting("Rotate", true,  v -> this.settings.getValue() == Settings.PLACE));
        this.altRotate = (Setting<Boolean>)this.register(new Setting("AltRotate", false,  v -> this.rotate.getValue() && this.settings.getValue() == Settings.PLACE));
        this.ground = (Setting<Boolean>)this.register(new Setting("NoJump", true,  v -> this.settings.getValue() == Settings.PLACE));
        this.noMove = (Setting<Boolean>)this.register(new Setting("NoMove", true,  v -> this.settings.getValue() == Settings.PLACE));
        this.packet = (Setting<Boolean>)this.register(new Setting("Packet", true,  v -> this.settings.getValue() == Settings.PLACE));
        this.render = (Setting<Boolean>)this.register(new Setting("Render", true,  v -> this.settings.getValue() == Settings.RENDER));
        this.colorSync = (Setting<Boolean>)this.register(new Setting("CSync", false,  v -> this.settings.getValue() == Settings.RENDER && this.render.getValue()));
        this.box = (Setting<Boolean>)this.register(new Setting("Box", true,  v -> this.settings.getValue() == Settings.RENDER && this.render.getValue()));
        this.bRed = (Setting<Integer>)this.register(new Setting("BoxRed", 150, 0, 255,  v -> this.settings.getValue() == Settings.RENDER && this.render.getValue() && this.box.getValue()));
        this.bGreen = (Setting<Integer>)this.register(new Setting("BoxGreen", 0, 0, 255,  v -> this.settings.getValue() == Settings.RENDER && this.render.getValue() && this.box.getValue()));
        this.bBlue = (Setting<Integer>)this.register(new Setting("BoxBlue", 150, 0, 255,  v -> this.settings.getValue() == Settings.RENDER && this.render.getValue() && this.box.getValue()));
        this.bAlpha = (Setting<Integer>)this.register(new Setting("BoxAlpha", 40, 0, 255,  v -> this.settings.getValue() == Settings.RENDER && this.render.getValue() && this.box.getValue()));
        this.outline = (Setting<Boolean>)this.register(new Setting("Outline", true,  v -> this.settings.getValue() == Settings.RENDER && this.render.getValue()));
        this.oRed = (Setting<Integer>)this.register(new Setting("OutlineRed", 255, 0, 255,  v -> this.settings.getValue() == Settings.RENDER && this.render.getValue() && this.outline.getValue()));
        this.oGreen = (Setting<Integer>)this.register(new Setting("OutlineGreen", 50, 0, 255,  v -> this.settings.getValue() == Settings.RENDER && this.render.getValue() && this.outline.getValue()));
        this.oBlue = (Setting<Integer>)this.register(new Setting("OutlineBlue", 255, 0, 255,  v -> this.settings.getValue() == Settings.RENDER && this.render.getValue() && this.outline.getValue()));
        this.oAlpha = (Setting<Integer>)this.register(new Setting("OutlineAlpha", 255, 0, 255,  v -> this.settings.getValue() == Settings.RENDER && this.render.getValue() && this.outline.getValue()));
        this.lineWidth = (Setting<Float>)this.register(new Setting("LineWidth", 1.5f, 0.1f, 5.0f,  v -> this.settings.getValue() == Settings.RENDER && this.render.getValue() && this.outline.getValue()));
        this.keepPos = (Setting<Boolean>)this.register(new Setting("KeepOldPos", false,  v -> this.settings.getValue() == Settings.MISC));
        this.updates = (Setting<Updates>)this.register(new Setting("Update", Updates.TICK,  v -> this.settings.getValue() == Settings.MISC));
        this.switchMode = (Setting<Switch>)this.register(new Setting("Switch", Switch.SILENT,  v -> this.settings.getValue() == Settings.MISC));
        this.allBlocks = (Setting<Boolean>)this.register(new Setting("AllBlocks", true,  v -> this.settings.getValue() == Settings.MISC));
