...
extends Module {
    ...
    public void onDisable() {
        ...
        Objects.requireNonNull(this.mc.func_147114_u()).func_147297_a((Packet)new CPacketEntityAction((Entity)this.mc.field_71439_g, CPacketEntityAction.Action.START_SNEAKING));
