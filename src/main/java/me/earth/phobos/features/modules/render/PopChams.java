...
public class PopChams extends Module
{
    ...
    public PopChams() {
        ...
        this.duration = (Setting<Integer>)this.register(new Setting("Duration", 2500, 100, 10000));
        this.fade = (Setting<Boolean>)this.register(new Setting("Fade", true));
        this.still = (Setting<Boolean>)this.register(new Setting("Static", true));
        this.heaven = (Setting<Boolean>)this.register(new Setting("Heaven", false,  v -> this.still.getValue()));
        this.ascension = (Setting<Double>)this.register(new Setting("Movement", 1.0, 0.1, 4.0,  v -> this.heaven.getValue() && this.still.getValue()));
        this.outline = (Setting<Boolean>)this.register(new Setting("Outline", true));
        this.fill = (Setting<Boolean>)this.register(new Setting("Fill", true));
        this.mode = (Setting<Mode>)this.register(new Setting("OutlineMode", Mode.WIREFRAME,  v -> this.outline.getValue()));
        this.lineWidth = (Setting<Float>)this.register(new Setting("LineWidth", 3.0f, 0.1f, 6.0f,  v -> this.outline.getValue()));
        this.oAlpha = (Setting<Integer>)this.register(new Setting("OAlpha", 255, 0, 255,  v -> this.outline.getValue()));
        this.fAlpha = (Setting<Integer>)this.register(new Setting("FAlpha", 50, 0, 255,  v -> this.fill.getValue()));
        this.colorSync = (Setting<Boolean>)this.register(new Setting("CSync", false,  v -> this.fill.getValue() || this.outline.getValue()));
        this.rainbow = (Setting<Boolean>)this.register(new Setting("Rainbow", false,  v -> this.fill.getValue() || this.outline.getValue()));
        this.oRed = (Setting<Integer>)this.register(new Setting("ORed", 255, 0, 255,  v -> !this.colorSync.getValue() && !this.rainbow.getValue() && this.outline.getValue()));
        this.oGreen = (Setting<Integer>)this.register(new Setting("OGreen", 0, 0, 255,  v -> !this.colorSync.getValue() && !this.rainbow.getValue() && this.outline.getValue()));
        this.oBlue = (Setting<Integer>)this.register(new Setting("OBlue", 180, 0, 255,  v -> !this.colorSync.getValue() && !this.rainbow.getValue() && this.outline.getValue()));
        this.fRed = (Setting<Integer>)this.register(new Setting("FRed", 255, 0, 255,  v -> !this.colorSync.getValue() && !this.rainbow.getValue() && this.fill.getValue()));
        this.fGreen = (Setting<Integer>)this.register(new Setting("FGreen", 0, 0, 255,  v -> !this.colorSync.getValue() && !this.rainbow.getValue() && this.fill.getValue()));
        this.fBlue = (Setting<Integer>)this.register(new Setting("FBlue", 180, 0, 255,  v -> !this.colorSync.getValue() && !this.rainbow.getValue() && this.fill.getValue()));
        this.visColor = (Setting<Boolean>)this.register(new Setting("VColor", false,  v -> !this.rainbow.getValue() && !this.colorSync.getValue() && this.fill.getValue()));
        this.vRed = (Setting<Integer>)this.register(new Setting("VRed", 50, 0, 255,  v -> !this.colorSync.getValue() && !this.rainbow.getValue() && this.visColor.getValue() && this.fill.getValue()));
        this.vGreen = (Setting<Integer>)this.register(new Setting("VGreen", 255, 0, 255,  v -> !this.colorSync.getValue() && !this.rainbow.getValue() && this.visColor.getValue() && this.fill.getValue()));
        this.vBlue = (Setting<Integer>)this.register(new Setting("VBlue", 180, 0, 255,  v -> !this.colorSync.getValue() && !this.rainbow.getValue() && this.visColor.getValue() && this.fill.getValue()));
        this.speed = (Setting<Integer>)this.register(new Setting("Speed", 40, 1, 100,  v -> this.rainbow.getValue() && !this.colorSync.getValue()));
        this.saturation = (Setting<Integer>)this.register(new Setting("Saturation", 65, 0, 100,  v -> this.rainbow.getValue() && !this.colorSync.getValue()));
        this.brightness = (Setting<Integer>)this.register(new Setting("Brightness", 100, 0, 100,  v -> this.rainbow.getValue() && !this.colorSync.getValue()));
