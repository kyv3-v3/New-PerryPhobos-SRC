...
extends Module {
    ...
    public void onUpdate() {
        ...
        while (blocks_placed < this.blocksPerTick.getValue()) {
            ...
            BlockPos target_pos = new BlockPos(Objects.requireNonNull(closest_target).func_174791_d()).func_177977_b().func_177982_a(offset_pos.func_177958_n(), offset_pos.func_177956_o(), offset_pos.func_177952_p());
