...
public class HUD extends Module
{
    ...
    public HUD() {
        ...
        this.customWatermark = (Setting<String>)this.register(new Setting("WatermarkName", (T)"megyn.club b1"));
        ...
        this.queue = (Setting<Boolean>)this.register(new Setting("2b2tQueue", (T)false, "Shows the 2b2t queue."));
        ...
        this.friendslist = (Setting<Boolean>)this.register(new Setting("Friends", (T)false));
        ...
        this.playerCount = (Setting<Integer>)this.register(new Setting("MaxPlayers", (T)8, (T)1, (T)30, v -> this.textRadar.getValue()));
