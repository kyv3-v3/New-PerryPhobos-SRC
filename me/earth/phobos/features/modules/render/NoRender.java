...
public class NoRender extends Module
{
    ...
    public NoRender() {
        ...
        this.markers = (Setting<Boolean>)this.register(new Setting("MapMarkers", (T)false, "Removes the 3d map markers."));
        ...
        this.explosions = (Setting<Boolean>)this.register(new Setting("Explosions", (T)false, "Removes crystal explosions."));
