...
public class Trajectories extends Module
{
    ...
    public Trajectories() {
        ...
        this.red = this.register(new Setting("Red", (T)0, (T)0, (T)255));
        this.green = this.register(new Setting("Green", (T)255, (T)0, (T)255));
        this.blue = this.register(new Setting("Blue", (T)0, (T)0, (T)255));
